...
def inference(input,
    ...
    sec2_out = section(input=sec1_out,
    ...
    sec3_out = section(input=sec2_out,
    ...
    sec4_out = section(input=sec3_out,
    ...
    fc_bn = bn_layer(sec4_out, layer_name='fc_bn')
